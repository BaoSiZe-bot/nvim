...
map("n", "]d", function() return show_diagnostic({ count = 1 }) end, { desc = "Next Diagnostic" })
map("n", "[d", function() return show_diagnostic({ count = -1 }) end, { desc = "Prev Diagnostic" })
map("n", "]e", function() return show_diagnostic({ count = 1, severity = 1 }) end, { desc = "Next Error" })
map("n", "[e", function() return show_diagnostic({ count = -1, severity = 1 }) end, { desc = "Prev Error" })
map("n", "]w", function() return show_diagnostic({ count = 1, severity = 2 }) end, { desc = "Next Warning" })
map("n", "[w", function() return show_diagnostic({ count = -1, severity = 2 }) end, { desc = "Prev Warning" })
